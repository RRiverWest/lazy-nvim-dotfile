...
map("s", "gd", "<Cmd>lua vim.lsp.buf.definition()<CR>")
map("s", "gD", "<Cmd>lua vim.lsp.buf.declaration()<CR>")
map("s", "gi", "<cmd>lua vim.lsp.buf.implementation()<CR>")
map("s", "gt", "<cmd>lua vim.lsp.buf.type_definition()<CR>")
map("s", "gn", "<cmd>lua vim.lsp.buf.rename()<CR>")
map("s", "ga", "<cmd>lua vim.lsp.buf.code_action()<CR>")
